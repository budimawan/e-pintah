...
class Periksapengajuan_superadmin extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('superadmin/pages/v_periksa', $data2);
	...
	public function periksa($id)
	{
		...
		$data2['pengajuan'] = $this->db->get_where('pengajuan_a', ['id' => $id])->row_array();
			...
			$this->load->view('template/header', $data);
			$this->load->view('superadmin/pages/v_periksa_pengajuan', $data2);
			$this->load->view('template/footer', $data);
	...
	public function cetakpdf($id)
	{
		...
		if ($session == $user) {
			...
			$this->load->view('user/pages/v_cetak_pengajuan', $data2);
			...
			$this->dompdf->render();
			$this->dompdf->stream("form_hak_pakai.pdf", array("Attachment" => false));
