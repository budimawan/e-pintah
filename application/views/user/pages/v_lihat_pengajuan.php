        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> <small>Permohonan Hak Pakai <?= $user['instansi'] ?> Tanggal <?php echo date('d-M-Y',strtotime($pengajuan["tgl_ajuan"]))?></small> </h3>
              <a href="<?= base_url();?>Pengajuanterkirim/cetakpdf/<?= $pengajuan['id'];?>" class="btn" target="_blank">
                            ...
                            <div class="card-body">
                              ...
                              <?php echo form_open_multipart('pengajuanterkirim/editPengajuan/');?>
                                ...
                                <div class="form-group  row" style="margin: 0px 0px -5px 0px;">
                                  ...
                                  <div class="col-sm-8">
                                    <label class="card-description col-form-label">Tanggal <strong><b>
                                    <?php 
                                      if ($pengajuan["pb_tgl"] != NULL){
                                        echo date('Y-m-d',strtotime($pengajuan["su_tgl"]));
                                      } else{
                                        echo ".............";
                                      }
                                    ?>
                                    </b></strong> Nomor  <strong><b>
                                    <?php 
                                      if ($pengajuan["su_no"] != NULL){
                                        echo $pengajuan["su_no"];
                                      } else{
                                        echo ".............";
                                      }
                                    ?>
                                ...
                                <div class="form-group  row" style="margin: 0px 0px -5px 0px;">
                                  ...
                                  <div class="col-sm-8">
                                    ...
                                    <?php 
                                      if ($pengajuan["pb_tgl"] != NULL){
                                        echo date('Y-m-d',strtotime($pengajuan["pb_tgl"]));
                                      } else{
                                        echo ".............";
                                      }
                                    ?>  
