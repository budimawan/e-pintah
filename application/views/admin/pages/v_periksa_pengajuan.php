            ...
            <div class="row">
              <div class="col-lg-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                        <div class="row"> 
                          <a href="<?= base_url();?>Pengajuanterkirim/download_file/<?= $pengajuan['file_d']?>" class="btn btn-sm" >
                            <button type="button" class="btn btn-warning btn-sm text-dark"><i class="mdi mdi mdi-file-pdf btn-icon-prepend"></i><small><i>download file permohonan hak pakai</i></small></button>
                          </a>
                            ...
                            <div class="card-body">
                              ...
                              <h6 class="card-description" style="margin: 0px 0px -2px 0px;">A. MENGENAI DIRI PEMOHON</h6>
                               ...
                               <?php echo form_open_multipart('Periksapengajuan/koreksiPengajuan/');?>
                                ...
                                <div class="card-description  row text-warning">
                                  ...
                                  <div class="col-md-2">
                                    <div class="custom-control custom-radio">
                                      ...
                                      <label class="custom-control-label text-success" for="customControlValidation2">Data Valid</label>
                                    </div>
                                    <div class="custom-control custom-radio mb-3">
                                      <input type="radio" class="custom-control-input" id="customControlValidation3" name="r_koreksi_a" required value="unvalid">
                                      <label class="custom-control-label text-danger" for="customControlValidation3">Data Unvalid</label>
                                ...
                                <div class="card-description  row text-warning">
                                  ...
                                  <div class="col-md-2">
                                    <div class="custom-control custom-radio">
                                      ...
                                      <label class="custom-control-label text-success" for="customControlValidation5">Data Valid</label>
                                    </div>
                                    <div class="custom-control custom-radio mb-3">
                                      <input type="radio" class="custom-control-input " id="customControlValidation6" name="r_koreksi_b" required value="unvalid">
                                      <label class="custom-control-label text-danger" for="customControlValidation6">Data Unvalid</label>
                                      <div class="invalid-feedback">More example invalid feedback text</div>
                                    </div>    
                                  </div>
                                  <div class="col-sm-10">
                                ...
                                <h6 class="card-description" style="margin: 0px 0px 0px 0px;">1. Fotocopy KTP / Surat Tanda Kewarganegaraan : 1 lembar <a href="<?= base_url();?>Periksapengajuan/download_file/<?= $pengajuan['file_a']?>" class=" "><i class="mdi mdi-small mdi-file-document"></i><small>Lihat KTP</small></button>
                                </a></h6>

                                <h6 class="card-description " style="margin: 0px 0px 0px 0px;">2. Surat Bukti perolehan/penguasaan tanah : 1 lembar <a href="<?= base_url();?>Periksapengajuan/download_file/<?= $pengajuan['file_b']?>" class=""><i class="mdi mdi-small mdi-file-document"></i><small>Lihat Surat</small></button>
                                </a></h6>
                                
                                <h6 class="card-description " style="margin: 0px 0px 0px 0px;">3. Surat Pernyataan Asset & Surat-Surat /Data Pendudukung Lainnya (bila ada) : masing-masing 1 lembar <a href="<?= base_url();?>Periksapengajuan/download_file/<?= $pengajuan['file_c']?>" class="">
                                  <i class="mdi mdi-small mdi-file-document"></i><small>Lihat File</small></button>
                                </a></h6>

                                <h6 class="card-description " style="margin: 0px 0px 0px 0px;">4. Permohonan Hak Pakai : 1 lembar <a href="<?= base_url();?>Periksapengajuan/download_file/<?= $pengajuan['file_d']?>" class="">
                                ...
                                <div class=" card-description row text-warning">
                                  ...
                                  <div class="col-md-2">
                                    <div class="custom-control custom-radio">
                                      ...
                                      <label class="custom-control-label text-success" for="customControlValidation7">Data Valid</label>
                                    </div>
                                    <div class="custom-control custom-radio mb-3">
                                      <input type="radio" class="custom-control-input" id="customControlValidation8" name="r_koreksi_c" required value="unvalid">
                                      <label class="custom-control-label text-danger" for="customControlValidation8">Data Unvalid</label>
                                      <div class="invalid-feedback">More example invalid feedback text</div>
                                    </div>    
                                  </div>
                                  <div class="col-sm-10">
