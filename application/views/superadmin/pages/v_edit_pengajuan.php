                          ...
                          <div class="card">
                            <div class="card-body">
                              ...
                              <p class="card-description"> Yang bertanda tangan di bawah ini kami 
                                ...
                                <input type="text" class="" id="kec2" name="kec2" placeholder="Nama kecamatan" value="<?= $pengajuan['kecamatan'] ?>">, dalam hal ini bertindak untuk dan atas nama <?= $user['instansi']?>, dengan ini mengajukan permohonan hak PAKAI dengan keterangan sebagai berikut :
                              </p>
                              ...
                              <h4 class="card-title text-center">A. MENGENAI DIRI PEMOHON</h4>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="letak_kab" name="letak_kab" placeholder="kabupaten" value="Konawe Selatan" required="" value="<?= $pengajuan['letak_kab']?>" >
                                  </div>
                                </div>
