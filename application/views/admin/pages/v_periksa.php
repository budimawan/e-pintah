              ...
              <div class="col-lg-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"><small>Table dibawah ini berisi riwayat/history pengajuan yang pernah dilakukan oleh OPD yang terdaftar aktif pada sistem pengajuan E-PINTAH. Setiap pengajuan form yang diajukan oleh OPD hanya dapat dilakukan pemeriksaan apabila status pengajuan <i>"Belum Diperiksa"</i>, periksalah form yang terkirim dengan baik untuk menghindari kesalahan pemeriksaan form. Hasil pemeriksaan tidak dapat diubah untuk kedua kalinya sampai, pemohon mengkonfirmasi hasil pemeriksaan! </code></small>
                    </p>
                                  ...
                                  <tr >
                                      ...
                                      <td class="<?php if ($d['peng_status'] == "unvalid"){
                                        echo "table-danger";
                                          ...
                                          echo "table-success";}?>">
                                          <small><?php if($d['peng_status'] != "terkirim" ) {echo "#." . $d['peng_status'];} ?><br>#. <?= $d['status_periksa']?></small>
                                      </td>
                                      <td class="<?php if ($d['peng_status'] == "unvalid"){
                                        echo "table-danger";
                                        } if ($d['peng_status'] == "valid"){
