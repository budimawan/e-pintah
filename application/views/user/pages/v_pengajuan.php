                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <p class="card-description text-warning" style="margin: -18px 0px 0px 0px;"><small>Persiapkan dokumen dokumen pendukung seperti : KTP, Surat Bukti Perolehan/Penguasaan Tanah, Surat Permohonan Hak Pakai, Surat Pernyataan Asset & Data Pendudukung Lainnya (bila ada). Setiap pengajuan yang terkirim hanya dapat di batalkan atau di edit apabila admin kantor pertanahan kota kendari telah memeriksa form pengajuan anda, pastikan data yang anda ajukan telah benar agar pengajuan anda valid ! </code></small>
                              </p>
                              ...
                              <p class="card-description"> Yang bertanda tangan di bawah ini kami 
                                ...
                                <input type="text" class="" id="kec2" name="kec2" placeholder="Nama kecamatan" required="">, dalam hal ini bertindak untuk dan atas nama Pemerintah Kabupaten Kota Kendari, dengan ini mengajukan permohonan hak PAKAI dengan keterangan sebagai berikut :
                              </p>
                              ...
                              <h4 class="card-title text-center">A. MENGENAI DIRI PEMOHON</h4>
                                ...
                                <div class="form-group row">
                                  <label for="exampleInput5" class="col-sm-12 col-form-label">Dalam hal ini bertindak untuk dan atas nama :  <strong>Pemerintah Kabupaten Konawe Selatan</strong></label>
                                </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="letak_kab" name="letak_kab" placeholder="kabupaten" value="Kota Kendari" required="" >
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                   <p class="card-description" for="invalidCheck"> Scan KTP dalam format (.pdf) contoh : <b><strong>KTP.pdf</strong></b>, lalu pastikan file tersebut memiliki ukuran <u class="text-warning">file tidak lebih dari 2046 KB / 2 MB</u>. </p>
                                ...
                                <hr>
                                <div class="form-group">
                                   <p class="card-description" for="invalidCheck"> Scan Surat Bukti perolehan/penguasaan tanah dengan format (.pdf) contoh : <b><strong>Surat_penguasaan_tanah.pdf</strong></b>, lalu pastikan file tersebut memiliki ukuran <u class="text-warning">file tidak lebih dari 2046 KB / 2 MB</u>. </p>
                                ...
                                <hr>
                                <div class="form-group">
                                   <p class="card-description" for="invalidCheck"> Gabungkan file scan 1.Surat Pernyataan Asset, 2.Surat-Surat/Data Pendudukung Lainnya (bila ada), dalam satu file dengan format (.pdf) contoh : <b><strong>file_scan_gabung.pdf</strong></b>, lalu pastikan file tersebut memiliki ukuran <u class="text-warning">file tidak lebih dari 2046 KB / 2 MB</u>. </p>
                                ...
                                <hr>
                                <div class="form-group">
                                   <p class="card-description" for="invalidCheck"> Scan Blangko Permohonan Hak Pakai yang sudah tertanda tangan dengan format (.pdf) contoh : <b><strong>Permohonan_hak_pakai.pdf</strong></b>, lalu pastikan file tersebut memiliki ukuran <u class="text-warning">file tidak lebih dari 2046 KB / 2 MB</u>. </p>
