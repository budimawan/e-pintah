            ...
            <div class="form-group row">
              ...
              <div class="card col-sm-5">
                <div class="text-center">GANTI PASSWORD</div>                  
                  <?php echo form_open_multipart('admin/gantipassword');?>
                  <div class="row no-gutters">
            ...
            <div class="form-group row" style="margin: -20px 0px 0px 0px;">
              <div class="card col-sm-12 text-small" >
                <div class="row no-gutters text-warning">
                  <h4 class="">Langkah - Langkah Melakukan Pemeriksaan Pengajuan :</h4>
                  <span class="card-description col-form-label" style="margin: -10px 0px 0px 0px;">1. Pilih Menu <strong class="text-warning">Periksa Pengajuan</strong>, lalu tentukan file pengajuan yang akan anda periksa dan tekan tombol <strong class="text-warning">periksa pengajuan</strong>. (tombol ini hanya aktif apa bila file yang anda pilih berstatus <strong class="text-warning">"<i>Belum Diperiksa"</i></strong>)</strong>.</span>
                  <span class="card-description col-form-label" style="margin: -10px 0px 0px 0px;">2. Tekan tombol <strong class="text-warning">download file permohonan hak pakai</strong>, dan file-file yang dilampirkan lainya sebagai acuan dalam pemeriksaan form permohonan pengajuan dari user/opd.</span>
                  <span class="card-description col-form-label" style="margin: -10px 0px 0px 0px;">3. Bacalah <strong class="text-warning">catatan</strong> yang diberikan oleh user/opd terlebih dahulu selaku pemohon, terkait data pengisian form yang akan diperiksa.</span>
                  <span class="card-description col-form-label" style="margin: -10px 0px 0px 0px;">4. Dalam proses pemeriksaan form pengajuan, terdapat <strong class="text-warning">tombol validasi data</strong> yaitu <strong class="text-warning"><i>"data valid/data unvalid"</i></strong>, pilih salah satu tombol validasi sesuai kebenaran data yang diperiksa.</span>
                  <span class="card-description col-form-label" style="margin: -10px 0px 0px 0px;">5. Masukkan koreksi pada <strong class="text-warning">kolom koreksi</strong> yang akan menjadi pesan kesalahan/perbaikan kepada user/opd pemilik pengajuan permohonan yang bersangkutan.</span>
                  <span class="card-description col-form-label" style="margin: -10px 0px 0px 0px;">6. Sebelum menekan tombol <strong class="text-warning">Submit</strong> Pastikan anda melakukan pemeriksaan data dengan benar, karena data yang diperiksa tidak dapat diperiksa kedua kalinya sampai pemohon mengkonfirmasi hasil pemeriksaan pengajuan.</span>
...
<div class="modal fade" id="newMenuModal" tabindex="-1" aria-labelledby="newMenuModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('admin/updatedatauser');?>
